...
class Users
{
	...
	public function updateUser()
	{
		...
		DB::query("INSERT INTO ".DB::table('kfss_smlog')." (type, username1, username2, descrip, timestamp, ip) VALUES('用户管理', '$username', '{$_G[username]}', '编辑股民 {$rs['username']} 信息', '$_G[timestamp]', '$_G[clientip]')");
	...
	public function exeDeleteUser()
	{
		...
		else
		{
			...
			DB::query("INSERT INTO ".DB::table('kfss_smlog')." (type, username1, username2, descrip, timestamp, ip) VALUES('用户管理', '$rs[username]', '{$_G[username]}', '$reason', '$_G[timestamp]', '$_G[clientip]')");
