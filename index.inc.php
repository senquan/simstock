...
$db_subscription	= $_G['cache']['plugin']['simstock']['subscription'];
$db_subscribecredit	= $_G['cache']['plugin']['simstock']['subscribecredit'];
$db_subscriptiontax = $_G['cache']['plugin']['simstock']['subscriptiontax'];
$db_spclosedate = $_G['cache']['plugin']['simstock']['spclosedate'];
$db_holdlimit = $_G['cache']['plugin']['simstock']['holdlimit'];
...
$modArray = array('index', 'stock', 'member', 'notice', 'news', 'ajax', 'system', 'misc');
try
{
